  ...
  Future<List<Order>> getAllOrders() async {
    ...
    return List.generate(maps.length, (i) {
      ...
      return Order(
        ...
        productName: maps[i][_orderColumnProductName], // Ambil item order secara terpisah jika menggunakan tabel _orderItemTable
      );
    });
  }
  ...
  Future<Order?> getOrderById(int id) async {
    ...
    if (maps.isNotEmpty) {
      ...
      return Order(
        ...
        // Ambil item order secara terpisah jika menggunakan tabel _orderItemTable
      );
    }
    return null;
  }
